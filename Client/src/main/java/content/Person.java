...
public class Person implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return height == person.height && name.equals(person.name) && passportID.equals(person.passportID) && hairColor == person.hairColor && nationality == person.nationality;
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, height, passportID, hairColor, nationality);
    }
}